  ...
  Formbuilder = (function() {
    Formbuilder.helpers = {
      defaultFieldAttrs: function(field_type) {
        ...
        attrs[Formbuilder.options.mappings.CLASS] = '';
        attrs['field_options'] = {};
...
(function() {
  Formbuilder.registerField('date', {
    order: 20,
    view: "<div class='input-line'><input type='text' class='rf-size-<%= rf.get(Formbuilder.options.mappings.SIZE) %>></div>",
    edit: "",
...
(function() {
  Formbuilder.registerField('sectionheading', {
    order: 6,
    view: "<h4></h4>",
    edit: "",
    addButton: "<span class=\"symbol\">&#182;</span> Section Heading",
    defaultAttributes: function(attrs) {
      attrs.field_options.size = 'small';
      return attrs;
    }
...
(function() {
  Formbuilder.registerField('fieldset', {
    ...
    view: "",
    edit: "",
    addButton: "<span class='symbol'><span class='fa fa-font'></span></span> Fieldset",
    defaultAttributes: function(attrs) {
      attrs.field_options.size = 'small';
      return attrs;
    }
...
(function() {
  Formbuilder.registerField('time', {
    order: 25,
    view: "<div class='input-line'><input class='rf-size-<%= rf.get(Formbuilder.options.mappings.SIZE) %> type='text' placeholder='Time in 24 hours format for Ex. 16:45'></div>",
    edit: "",
...
'<select data-rv-input="model.class"><option value="">Size</option><option value="col-md-4">Small</option><option value="col-md-6">Medium</option><option value="col-md-12">Large</option></select>';
