...
(function ($, document, window) {
    ...
    $.fn.weatherFeed = function (options) {
        ...
        this.each(function () {
            ...
            var codeImgURL = options.pluginPath+"images/weather/";
                ...
                success: function (response) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            var weatherListItem = "<h2 class='weather'>" + title + " " + hourMod + (today.getHours() + dstOffset) + minMod + today.getMinutes() + " " + timeZone + " " + "<span class='lastUpdate'>Last Updated at " + time + " " + timeZone + "</span></h2><ul class='weatherSummary col-md-12 nopadding'>";
                            ...
                            for (var i = 0; i < data.query.results.channel.item.forecast.length && i < days; i++) {
                                ...
                                if (i == 0) {
                                    ...
                                    dayDom = "<li class='today' style='border:none !important'>" + day + image + date + description + tempSummary + "</li>";
                                    ...
                                    dayDom = "<li class='fullDay forecast' style='border:none !important'>" + day + image + date + description + "<p>" + high + "&nbsp;-" + low + "</p></li>";
                            ...
                            $weatherTag.find(".weatherSummary").css('background', 'url(' + background + ')');
